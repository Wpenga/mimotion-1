...
min_dict = {time_list[0]: 400, time_list[1]: 6000, time_list[2]: 10000, time_list[3]: 20000, time_list[4]: 23000, time_list[5]: 24000, time_list[6]: 25000}
# 最大步数（例如现在设置意思是在8点（你设置的第一个时间点默认8）运行会在1500到2999中随机生成一个数提交（开启气候降低步数会乘系数K）10点3000~4999。。。以此类推，步数范围建议看懂了再改，没看懂直接默认就好）
max_dict = {time_list[0]: 5999, time_list[1]: 9999, time_list[2]: 19999, time_list[3]: 22999, time_list[4]: 23999, time_list[5]: 24999, time_list[6]: 34999}
# 设置结束
